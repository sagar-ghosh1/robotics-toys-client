      ...
      <div className="hero min-h-screen" style={{ backgroundImage: `url("https://rb.gy/dqrkb")` }}>
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className='text-white'>
            ...
            <button className="btn bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 border-none" data-aos="zoom-in" data-aos-easing="ease-out-cubic" data-aos-duration="500">Back to Home</button>
          </div>
        </div>
      </div>
